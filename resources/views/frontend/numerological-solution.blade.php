    ...
    <section class="container">
        ...
        <div class="px-4">
            <div class="row justify-content-around">
                ...
                <div class="card p-3 m-4 col-md-5 col-sm-12">
                    <div class="card-item p-3">
                        <img src="{{asset('frontend/AstromarG/compatibility_analysis.png')}}" class="img-fluid" alt="" style="height:15rem; width:100%;">
                    </div>
                    <div class="card-body pt-3">
                ...
                <div class="card p-3 m-4 col-md-5 col-sm-12">
                    <div class="card-item p-3">
                        <img src="{{asset('frontend/AstromarG/name_change.jpeg')}}" class="img-fluid" alt="" style="height:15rem; width:100%;">
                    </div>
                    <div class="card-body pt-3">
                ...
                <div class="card p-3 m-4 col-md-5 col-sm-12">
                    <div class="card-item p-3">
                        <img src="{{asset('frontend/AstromarG/buisness_branding.jpeg')}}" class="img-fluid" alt="" style="height:15rem; width:100%;">
                    </div>
                    <div class="card-body pt-3">
                ...
                {{-- <div class=" col-md-10 col-sm-12 mt-4 px-5">
                <div class="cad d-flex p-5">
                    <div class="card-item " style="width:120rem;">
                        <img src="{{asset('frontend/AstromarG/buisness_branding.jpeg')}}" alt="" style="height:15rem; width:100%;">
                    </div>
