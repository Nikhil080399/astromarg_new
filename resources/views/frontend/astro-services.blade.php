...
@section('body')
    ...
    <div class="astro_service">
        ...
        <section class="heading">
            <h1 class="text-center text-light pt-5 mt-5 " style="font-size:3rem; ">Astro Services</h1>
        </section>
        ...
        <section id="for-title" class="main-heading px-3">
            ...
            <div class="for-cards row">

                {{-- <div class="col-md-6 col-sm-12 ps-5"> --}}

                <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                    <div class="row g-0">
                        <div class="col-md-5">
                            <img src="{{ asset('frontend/AstromarG/Pics/birth_chart_calculato.png') }}"
                ...
                <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                    <div class="row g-0">
                        <div class="col-md-5">
                            <img src="{{ asset('frontend/AstromarG/Pics/horoscope_reading.jpeg') }}"
                                class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-7">
                            <div class="card-body">
                ...
                <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                    <div class="row g-0">
                        <div class="col-md-5">
                            <img src="{{ asset('frontend/AstromarG/compatibility_analysis.png') }}"
                                class="img-fluid rounded-start" alt="...">
                ...
                <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                    <div class="row g-0">
                        <div class="col-md-5">
                            <img src="{{ asset('frontend/AstromarG/Pics/career_guidance.jpg') }}"
                                class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-7">
                            <div class="card-body">
                ...
                <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                    <div class="row g-0">
                        <div class="col-md-5">
                            <img src="{{ asset('frontend/AstromarG/Pics/marriage_relationship.jpg') }}"
                                class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-7">
                            <div class="card-body">
                ...
                <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                    <div class="row g-0">
                        <div class="col-md-5">
                            <img src="{{ asset('frontend/AstromarG/Pics/health_well_being.png') }}"
                                class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-7">
                            <div class="card-body">
            ...
            <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                <div class="row g-0">
                    <div class="col-md-5">
                        <img src="{{ asset('frontend/AstromarG/remedies.jpg') }}"
                            class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
            ...
            <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                <div class="row g-0">
                    <div class="col-md-5">
                        <img src="{{ asset('frontend/AstromarG/Pics/education.jpeg') }}"
                            class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
            ...
            <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                <div class="row g-0">
                    <div class="col-md-5">
                        <img src="{{ asset('frontend/AstromarG/Pics/muhurtha.jpg') }}"
                            class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
            ...
            <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                <div class="row g-0">
                    <div class="col-md-5">
                        <img src="{{ asset('frontend/AstromarG/Pics/career-counselling.jpg') }}"
                            class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
            ...
            <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                <div class="row g-0">
                    <div class="col-md-5">
                        <img src="{{ asset('frontend/AstromarG/Pics/childbirth_timming.jpeg') }}"
                            class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
            ...
            <div class="card col-md-6 col-sm-12 mb-3 bg-transparent">
                <div class="row g-0">
                    <div class="col-md-5">
                        <img src="{{ asset('frontend/AstromarG/Pics/Business-Consultant.jpg') }}"
                            class="img-fluid rounded-start" alt="...">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
