                    ...
                    <a href="{{route('adduser')}}" class="text-primary text-gradient font-weight-bold">Sign up</a>
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('');1background-size: 100%; background-repeat: no-repeat; ">
                                <span class="mask bg-gradient-primary opacity-6">
                                    <img src="{{ asset('assets/images/mrb_logo.png') }}" alt="" class="pt-5">
                                </span>
                                <h4 class="mt-10 text-white font-weight-bolder position-relative">"Attention is the new
                                    currency"</h4>
