        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Video Gallery</h6>
                </nav>
                {{-- half-nav  --}}
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <form class="px-5" action="insert_video" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="d-flex">
                                        ...
                                        @foreach ($video as $item)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ url('video_gallery/edit/' . $item->id) }}"
                                                        <span class="badge badge-sm bg-gradient-info">Edit</span></a>
                                                </td>

                                                <td class="align-middle">
                                                    <a href="{{ url('video_gallery/delete/' . $item->id) }}"
                                                        onclick="return confirm('Are you sure you want to delete this video?')">
                                                        <span class="badge badge-sm bg-gradient-danger">Delete</span></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
