                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <form class="px-5" action="{{ route('image.update', ['id' => $image_gallery->id]) }}"
                                ...
                                <div class="d-flex">
                                    <div class="mb-3 mx-3 w-50">
                                        ...
                                        <input type="file" class="form-control" name="image" id="image"
                                            value="{{ $image_gallery->image }}">
                                        <img src="{{ asset('storage/images/' . $image_gallery->image) }}" class="pt-2"
                                            alt="..." style="width: 100px!important;height:100px;">
                                    </div>
                                    <div class="mb-3 mx-3 w-50">
                                        <label for="title" class="form-label">Title</label>
                                        <input type="text" class="form-control" name="title" id="title"
                                            value="{{ $image_gallery->title }}">
                                    </div>
                                </div>
