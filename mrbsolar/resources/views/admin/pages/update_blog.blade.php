                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <form class="px-5" action="{{ route('blog.update', ['id' => $blog->id]) }}"
                                ...
                                <div class="d-flex">
                                    <div class="mb-3 mx-3 w-50">
                                        ...
                                        <input type="file" class="form-control" name="image" id="image"
                                            value="{{ $blog->image }}">
                                        <img src="{{ asset($blog->image) }}" class="pt-2" alt="..." style="width: 100px!important;height:100px;">
                                    </div>
                                    <div class="mb-3 mx-3 w-50">
                                ...
                                <div class="d-flex">
                                    <div class="mb-3 mx-3 w-100">
                                        ...
                                        <textarea style="max-width: 100%" type="text" class="form-control" name="discription" id="discription" cols="120" rows="4" required>{{ $blog->discription }}</textarea>
                                    </div>
                                </div>
                                <div class="pe-7 text-end">
                                    <button type="submit" class="btn btn-primary me-2">Update</button>
                                    <a href="{{ Route('blog_back') }}">
