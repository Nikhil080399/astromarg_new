                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <form class="px-5" action="interest_cat" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="d-flex">
                                        ...
                                        @foreach ($interests as $item)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ url('interest/edit/' . $item->id) }}" <span
                                                        class="badge badge-sm bg-gradient-info">Edit</span></a>
                                                </td>

                                                <td class="align-middle">
                                                    <a href="{{ url('interest/delete/' . $item->id) }}"
