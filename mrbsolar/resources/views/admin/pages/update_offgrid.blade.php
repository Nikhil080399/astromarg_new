        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Off Grid Rooftop</h6>
                </nav>
                {{-- half-nav  --}}
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <h6>Off Grid Rooftop</h6>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <form class="px-5" action="{{ route('offgrid.update', ['id' => $off_Gird_system->id]) }}"
                                ...
                                <div class="d-flex">
                                    <div class="mb-3 mx-3 w-50">
                                        ...
                                        <input type="text" class="form-control" name="roof_of_area" id="area"
                                            value="{{ $off_Gird_system->roof_of_area }}">
                                    </div>
                                    <div class="mb-3 mx-3 w-50">
                                        <label for="title" class="form-label">Title</label>
                                        <input type="text" class="form-control" name="title" id="title"
                                            value="{{ $off_Gird_system->title }}">
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="mb-3 mx-3 w-100">
                                        ...
                                        <textarea style="max-width: 100%" type="text" class="form-control" name="points" id="points" cols="120"
                                            rows="4" required>{{ $off_Gird_system->points }}</textarea>
                                    </div>
                                </div>
                                <div class="pe-7 text-end">
                                    <button type="submit" class="btn btn-primary me-2">Update</button>
                                    <a href="{{ Route('off_grid_system') }}">
