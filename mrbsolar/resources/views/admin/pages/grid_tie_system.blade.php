        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Grid Tie System</h6>
                </nav>
                {{-- half-nav  --}}
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <h6>Grid Tie System</h6>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <form class="px-5" action="grid_tie_system" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="d-flex">
                                        ...
                                        @foreach ($grid as $item)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ url('Gird_Tie_system/edit/' . $item->id) }}" <span
                                                        class="badge badge-sm bg-gradient-info">Edit</span></a>
                                                </td>

                                                <td class="align-middle">
                                                    <a href="{{ url('Gird_Tie_system/delete/' . $item->id) }}"
